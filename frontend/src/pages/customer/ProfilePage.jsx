          ...
          <div className="absolute inset-0 bg-black/50 z-50 flex items-center justify-center p-6 backdrop-blur-sm">
            <div className="bg-white w-full max-w-sm rounded-3xl p-6 shadow-2xl flex flex-col gap-4">
              <div className="flex items-center justify-between pb-2 border-b border-gray-100">
                ...
                <button type="button" onClick={() => setShowEditProfileModal(false)} className="w-8 h-8 rounded-full bg-gray-100 flex items-center justify-center text-gray-500">
                  <X size={16} />
                </button>
              </div>
              ...
              <form onSubmit={handleSaveProfile} className="flex flex-col gap-3">
                ...
                <div className="flex gap-2 pt-2">
                  <button type="button" onClick={() => setShowEditProfileModal(false)} className="flex-1 py-2.5 rounded-xl border border-gray-200 text-gray-600 font-bold text-xs">
                    ยกเลิก
                  </button>
                  <button type="submit" style={{ backgroundColor: '#1d61f2', color: '#ffffff' }} className="flex-1 py-2.5 rounded-xl font-bold text-xs shadow-md">
                    บันทึก
                  </button>
                </div>
              </form>
          ...
          <div className="absolute inset-0 bg-black/50 z-50 flex items-center justify-center p-6 backdrop-blur-sm">
            <div className="bg-white w-full max-w-sm rounded-3xl p-6 shadow-2xl flex flex-col gap-4">
              <div className="flex items-center justify-between pb-2 border-b border-gray-100">
                ...
                <button type="button" onClick={() => setShowAddressModal(false)} className="w-8 h-8 rounded-full bg-gray-100 flex items-center justify-center text-gray-500">
                  <X size={16} />
                </button>
              </div>
              ...
              <form onSubmit={handleSaveAddress} className="flex flex-col gap-3">
                ...
                <div>
                  <div className="flex justify-between items-center mb-1">
                    ...
                    <button type="button" onClick={handleSimulatePickMap} className="text-[11px] text-[#1d61f2] font-bold flex items-center gap-1">
                      <Navigation size={12} /> {isSimulatingMap ? 'กำลังค้นหา...' : 'ใช้ตำแหน่งปัจจุบัน'}
                    </button>
                  </div>
                  
                  <div onClick={handleSimulatePickMap} className="w-full h-28 bg-slate-100 rounded-2xl border-2 border-dashed border-blue-200 flex flex-col items-center justify-center cursor-pointer">
                ...
                <div>
                  <label className="text-xs font-bold text-gray-700 block mb-1">รายละเอียดที่อยู่</label>
                  <textarea
                    rows="2"
                    required
                    value={addressDetail}
                ...
                <div className="flex gap-2 pt-1">
                  <button type="button" onClick={() => setShowAddressModal(false)} className="flex-1 py-2.5 rounded-xl border border-gray-200 text-gray-600 font-bold text-xs">
                    ยกเลิก
                  </button>
                  <button type="submit" style={{ backgroundColor: '#1d61f2', color: '#ffffff' }} className="flex-1 py-2.5 rounded-xl font-bold text-xs">
                    บันทึกหมุด
                  </button>
                </div>
              </form>
          ...
          <div className="absolute inset-0 bg-black/50 z-50 flex items-center justify-center p-6 backdrop-blur-sm">
            <div className="bg-white w-full max-w-sm rounded-3xl p-6 shadow-2xl flex flex-col gap-3.5">
              <div className="flex items-center justify-between pb-2 border-b border-gray-100">
                ...
                <button type="button" onClick={() => setShowReportModal(false)} className="w-8 h-8 rounded-full bg-gray-100 flex items-center justify-center text-gray-500">
                  <X size={16} />
                </button>
              </div>
              ...
              {reportSuccess ? (
                ...
                <form onSubmit={handleSubmitReport} className="flex flex-col gap-3">
                  ...
                  <div className="flex gap-2 pt-1">
                    <button type="button" onClick={() => setShowReportModal(false)} className="flex-1 py-2.5 rounded-xl border border-gray-200 text-gray-600 font-bold text-xs">
                      ยกเลิก
                    </button>
                    <button type="submit" style={{ backgroundColor: '#ea580c', color: '#ffffff' }} className="flex-1 py-2.5 rounded-xl font-bold text-xs">
                      ส่งรายงาน
                    </button>
                  </div>
                </form>
